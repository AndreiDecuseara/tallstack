  ...
  <div class="container h-screen m-auto text-center">
    ...
    <div class="w-1/2 pt-10 m-auto mt-10 ">
      <div class="flex justify-between">
        <a target="_blank" href="https://laravel.com/docs/8.x" class="z-10 flex items-center px-8 py-3 rounded-lg shadow-inner bg-gray-50 flex-column">
          <img width=25 height=25 src="https://laravel.com/img/logomark.min.svg"></img>
          <p class="ml-1 text-xl text-red-500" >Laravel</p>
        </a>
        <a target="_blank" href="https://tailwindcss.com/docs" class="z-10 flex items-center px-8 py-3 rounded-lg shadow-inner bg-gray-50">
        ...
        <a target="_blank" href="https://laravel-livewire.com/docs/2.x/quickstart" class="z-10 flex items-center px-8 py-3 rounded-lg shadow-inner bg-gray-50">
          <img width=25 height=25 src="https://laravel-livewire.com/favicon.ico"></img>
          <p class="ml-1 text-xl text-indigo-600" >Livewire</p>
        </a> 
        <a target="_blank" href="https://alpinejs.dev/start-here" class="z-10 flex items-center px-8 py-3 rounded-lg shadow-inner bg-gray-50">
